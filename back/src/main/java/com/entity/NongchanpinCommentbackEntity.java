...
public class NongchanpinCommentbackEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public NongchanpinCommentbackEntity() {

	}

	public NongchanpinCommentbackEntity(T t) {
		try {
    ...
    public String toString() {
        return "NongchanpinCommentback{" +
            "id=" + id +
            ", nongchanpinId=" + nongchanpinId +
            ", yonghuId=" + yonghuId +
            ", nongchanpinCommentbackText=" + nongchanpinCommentbackText +
