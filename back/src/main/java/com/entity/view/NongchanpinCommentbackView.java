...
public class NongchanpinCommentbackView extends NongchanpinCommentbackEntity implements Serializable {
	...
	public NongchanpinCommentbackView() {

	}

	public NongchanpinCommentbackView(NongchanpinCommentbackEntity nongchanpinCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, nongchanpinCommentbackEntity);
